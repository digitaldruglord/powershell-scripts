...
# alternate target dir "C:\Users\" + $env:userprofile +"\AppData\Local\Programs\Python\Python38\"
$targetDir = "C:\Python38"

# create the download directory and get the exe file
$pythonNameLoc = $tempDirectory + "python-3.8.1-amd64.exe"
New-Item -ItemType directory -Path $tempDirectory -Force | Out-Null
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
(New-Object System.Net.WebClient).DownloadFile($pythonUrl, $pythonNameLoc)

# silent arguments for the install of python
$Arguments = @()
$Arguments += "/i"
...
# alternate path dir "C:\Users\" + $env:userprofile +"\AppData\Local\Programs\Python\Python38\"
